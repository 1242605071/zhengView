...
public class ProgressHUD
{
    ...
    public ProgressHUD(Context context) {
        ...
        mWindowColor = context.getResources().getColor(R.color.black_500000);
        mCornerRadius = 10;
        mProgressHUDDialog.setSize(70, 70);
        //转圈圈的圆形view
    ...
    private class ProgressHUDDialog extends Dialog
    {
        ...
        private void updateBackgroundSize() {
            ...
            params.width = dpUtils.dpToPixel(mWidth, getContext());
            params.height = dpUtils.dpToPixel(mHeight, getContext());
